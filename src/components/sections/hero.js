...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Mir Burhan.</h2>;
  ...
  const five = (
    <span>
      <p>Want to build something amazing and interesting?</p>
      <a
        className="email-link"
        href="https://www.upwork.com/freelancers/~01a061a3e517039d46"
        target="_blank"
        rel="noreferrer">
        Hire Me
      </a>
